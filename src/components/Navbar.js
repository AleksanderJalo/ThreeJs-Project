...
const Navbar = () => {
  return (
    <div className='flex w-full justify-evenly items-center border-solid bg-slate-900 text-white font-fixedsys text-2xl '>
      ...
      <div>
        <img className='w-[200px] h-[150px]' src='/logo.png' alt="logo"></img>
      </div>
      <div className='flex justify-around'>
